...
public class TupleDesc implements Serializable {
    ...
    public Type getFieldType(int i) throws NoSuchElementException {
        ...
        throw new NoSuchElementException("ArrayIndexOutOfBoundsException");
    }
    ...
    public int fieldNameToIndex(String name) throws NoSuchElementException {
        ...
        throw new NoSuchElementException("not found the index of the field with "+ name);
    }
    ...
    public int hashCode() {
        ...
        return Arrays.asList(tdItems).hashCode();
    ...
    public String toString() {
        ...
        for(int i = 0;i < tdItems.length;i++){
            sb.append(tdItems[i].fieldType).append("(").append(tdItems[i].fieldName).append(")").append(",");
        }
